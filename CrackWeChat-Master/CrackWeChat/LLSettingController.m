...
//    [redEnvelopesSection addCell:filterRoomCell];
    ...
    MMTableViewCellInfo *githubCell = [NSClassFromString(@"MMTableViewCellInfo") normalCellForSel:@selector(onGithubCellClicked) target:self title:@"Blog" rightValue:@"安静的傻子" accessoryType:1];
...
- (void)onGithubCellClicked{
    NSURL *myGithubURL = [NSURL URLWithString:@"http://tomatobin.lofter.com"];
